...
class PlayerTest {
    ...
    @Test
    void keyPressed() {
        int afterPlacing = player.actions.size() + 1;
        player.keyPressed(1);
        assertEquals(afterPlacing, player.actions.size());
        int afterRemoving = player.actions.size() - 1;
        player.keyPressed(1);
        assertEquals(afterRemoving, player.actions.size());
    }
}